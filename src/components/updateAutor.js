...
const UpdateAutor = () =>{
    ...
    const [errors, setErrors] = useState({}); //dic de errores para las validaciones

    const history = useHistory(); //para la redirección

    useEffect(() =>{
        axios.get("http://localhost:8000/api/autors/"+id)
